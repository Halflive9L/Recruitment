 ...
 * @since 8/11/2017
 */
public class AddAllProspectTagsPresenter implements Consumer<List<AddTagResponseModel>> {
    ...
    public void accept(List<AddTagResponseModel> responseModels) {
        if (responseModels == null) {
            responseEntity = new ResponseEntity<>(Collections.singleton("Prospect does not exist"),
